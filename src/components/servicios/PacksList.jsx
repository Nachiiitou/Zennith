...
<div className="bg-[#0e1a26] p-6 rounded-xl border border-[#1de9b6] shadow-lg shadow-[#1de9b622] ring-1 ring-[#1de9b6]/20 hover:shadow-2xl hover:-translate-y-1 transition-all duration-300">
  <div className="max-w-md mx-auto text-center">
    ...
    <div className="text-center mt-4">
      ...
      >
        ...
        {/* CARD 2: Pack Profesional */}
        <div className="bg-[#0e1a26] p-6 rounded-xl shadow-md border border-[#1de9b6]">
          <h3 className="text-xl font-semibold text-[#1de9b6] mb-3">{packs.pack2.nombre}</h3>
          <p className="text-gray-300 mb-4">{packs.pack2.descripcion}</p>
          <p className="text-lg font-bold text-white mb-6">{packs.pack2.precio}</p>
        ...
        {/* CARD 3: Pack Full */}
        <div className="bg-[#0e1a26] p-6 rounded-xl shadow-md border border-[#1de9b6]">
          <h3 className="text-xl font-semibold text-[#1de9b6] mb-3">{packs.pack3.nombre}</h3>
          <p className="text-gray-300 mb-4">{packs.pack3.descripcion}</p>
          <p className="text-lg font-bold text-white mb-6">{packs.pack3.precio}</p>
          <button className="bg-[#1de9b6] text-black font-medium py-2 px-4 rounded hover:bg-[#13c8a2] transition-colors">
            {packDev.boton}
          </button>
        </div>
      ...
      {/* MODAL DEL PACK 1 */}
      <BaseModal isOpen={openModal} onClose={() => setOpenModal(false)}>
