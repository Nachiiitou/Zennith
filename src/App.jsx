...
<section aria-label="Testimonios de Clientes" className="px-6 lg:px-24 py-16 z-10 relative">
  ...
  <div className="flex flex-col items-center gap-6 text-gray-500 md:flex-row md:justify-between">
    
    {/* Izquierda: Logo */}
    <div className="flex items-center gap-3">
      <img src="/logo.png" alt="Logo pequeño de Zennith" className="h-12 w-12" />
      <span className="text-[#1de9b6] font-semibold text-lg">ZENNITH</span>
    </div>
    ...
    <p className="text-gray-500 text-sm text-center md:text-right">
      © 2025 Zennith SpA. Todos los derechos reservados.
    </p>
  </div>
</footer>
