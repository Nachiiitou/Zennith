...
export default function SobreNosotros() {
  ...
  return (
    <section className="px-6 lg:px-24 py-16 bg-[#02070f] text-white">
      ...
      {/* Filosofía */}
      <div className="max-w-5xl mx-auto rounded-xl p-8 mb-20 shadow-lg border border-[#1de9b6]/10 bg-[#0e1a26]">
        <motion.h3
      ...
      >
        ...
        <Link
          to={`/${lang}/contacto`}
          className="inline-block bg-[#1de9b6] text-black px-6 py-2 rounded-full font-semibold hover:bg-[#13c8a2] transition cursor-pointer"
        >
