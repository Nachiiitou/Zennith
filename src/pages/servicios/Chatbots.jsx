...
function Chatbots() {
  ...
  const data = t("servicios.chatbots", { returnObjects: true });
          ...
          */}
          ...
          <div className="bg-[#0a101a] p-12 rounded-xl shadow-lg text-center mt-20">
            ...
            <p className="text-gray-400 mb-6 max-w-2xl mx-auto">
              Agenda una asesoría y creemos un chatbot que atienda, resuelva y convierta por ti.
            </p>
            <button
