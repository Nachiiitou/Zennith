...
function ConsultoriaTecnologica() {
  const { lang } = useParams();
  const { t } = useTranslation();
  const data = t("servicios.consultoria-tecnologica", { returnObjects: true });
      ...
      <section className="bg-[#02070f] text-white py-20 px-6 lg:px-32">
        <div className="max-w-7xl mx-auto">
          ...
          {data.beneficios && (
            <div className="mb-20">
              <h2 className="text-2xl font-semibold text-[#1de9b6] mb-6">
                Beneficios de la consultoría tecnológica
              </h2>
          ...
          {data.ejemplos && (
            <div className="mb-20">
              <h2 className="text-2xl font-semibold text-[#1de9b6] mb-6">
                Algunas formas en que podemos ayudarte
              </h2>
              <div className="grid sm:grid-cols-1 md:grid-cols-2 gap-6">
          ...
          */}
          ...
          <div className="bg-[#0a101a] p-12 rounded-xl shadow-lg text-center mt-20">
            <h3 className="text-3xl font-bold text-[#1de9b6] mb-4">
              ¿Listo para tomar decisiones tecnológicas acertadas?
            </h3>
            <p className="text-gray-400 mb-6 max-w-2xl mx-auto">
              Agenda una asesoría sin compromiso y llevemos tu estrategia digital al siguiente nivel.
            </p>
            <button
